...
class nea extends CI_Controller {
	...
	function __construct ()
	{
		...
		$this->load->model(array('nea_model','admin_model','training_model'));
	...
	public function add_heasave(){
		...
		$this->load->helper('security');
		$this->form_validation->set_rules('courseid', 'courseid', 'required|xss_clean|trim');
		$this->form_validation->set_rules('schoolid', 'schoolid', 'required|xss_clean|trim');
	...
	public function add_cpcesave(){
		...
		{
			$data = $this->nea_model->add_cpcesave();
			$data['rec'] = $data;
	...
	public function add_lsesave(){
		...
		$this->load->helper('security');
		$this->form_validation->set_rules('licid', 'License Id', 'required|xss_clean|trim');
		$this->form_validation->set_rules('rankid', 'rankid', 'required|xss_clean|trim');
		$this->form_validation->set_rules('datedis', 'datedis', 'required|xss_clean|trim');
		$this->form_validation->set_rules('employid', 'Shipping Principal', 'required|xss_clean|trim');
		$this->form_validation->set_rules('mnum', 'mobile number', 'xss_clean|trim');
		$this->form_validation->set_rules('lnum', 'landline number', 'xss_clean|trim');
		$this->form_validation->set_rules('sprin', 'Company name', 'required|xss_clean|trim');
		...
		{
			$data = $this->nea_model->add_lsesave();
			$data['rec'] = $data;
