...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    	<title>LCCA Funds Report - Cash Collection Information System</title>
	...
	.noborder {
		...
		<div style="width:13in">	
			...
			?>
				<table style="font-size:11px; width:13in">
					<thead>
						<tr>
							<td colspan="3" align="center">
								<b style="font-size:17px">CASH RECEIPTS REGISTER</b><br>
								<font style="font-size:12px">LCCA</font>
							</td>
						</tr>
					</thead>
					<tbody>
			...
			<table id="bottable" style="border:1px solid #000; width:13in; border-collapse:collapse;">
				<thead>
					<tr>
				...
				<tfoot>
					<tr>
						<td colspan="<?php echo $report->num_rows() + 6;?>" align="center"></td>
				...
				<tbody>
					...
					for ($i = 0; 25 > $i; $i++)
					{
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td align="right"><?php echo $begbal["amount"]; $lolss = $total_balance2 = $total_balance = $begbal["amount"];  ?></td>
							<td colspan="<?php echo $report->num_rows() + 3;?>" align="center"></td>
						</tr>
						
						<?php
						}
						if ($counter == 1 and $rphead_arr_1 != 1) { #--------kun first row hea amo ini it magawas?> 
						<tr>
							...
							<td></td>
							<td></td>
							<td align="right"><?php echo $total_others_tanan ?></td>
						</tr>
						...
						<tr>
							...
							foreach ($z as $rowx => $key) #loop an waray ha header na mga fees
							{
								...
								if (!empty($yy[2]))
								{
									$feewithsurat = (!empty($yy[3]) ? $yy[3] : $yy[2]);
