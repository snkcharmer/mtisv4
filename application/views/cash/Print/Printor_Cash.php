<div style="width: 8.5in; font-family: Calibri, sans-serif;">
	...
	<div style="padding:1.8in 0in 0in 0.8in; width: 5.1in; height: auto;">
		...
		<div style="height: 0.5in">
			<table>
				<tr>
					<td style="text-align: right; width: 3.25in ">Php</td>
					<td style="text-align: right; width: 1in "><?php echo number_format($totalam, 2, '.', ' '); ?></td>
				</tr>
			</table>
		</div>
		<div style="text-align: center; height: 0.50in; font-size: 17px;">
		...
		<div style="text-align: right; height: 0.5in; padding-right:80px;">
