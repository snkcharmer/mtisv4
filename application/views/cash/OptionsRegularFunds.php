		...
		<div class="midShadow" id="content">
			<div id="generalinfo" class="column">
				<div id="generalinfo_header">
					<p>
						Add Modules on Report for Regular Funds
					</p>
				</div>
					...
					<form name='search' action='<?php echo base_url()?>cash/insert_reportheader_regularfunds' method='post'>
					...
					<div style="float:left; margin-left: 10px; width: 65%">
						...
						<table cellspacing="0" cellpadding="0" style="width: 100%">
							...
							<tr>
								<td style="text-align:center;"><?php echo $rows['repid']?></td>
								<td style="text-align:left;"><?php echo $rows['typename']." - ".$rows['descriptn']?></td>
								<td align="left">
									<a href='<?php echo base_url()?>cash/delete_report_header/regularfunds/<?php echo $rows['repid'];?>' onclick="return confirm('Are you sure you want to Delete?');">Delete</a>
								</td>
							</tr>
							<?php } ?>
						</table>
