		...
		<div class="midShadow" id="content">
			<div id="generalinfo" class="column">
				<div id="generalinfo_header">
					<p>
						Edit Payment List: <?php echo (empty($record["module"]) ? $record["typename"] : $record["module"]); ?>
					</p>
				</div>
				<form name='search' action='<?php echo base_url()?>cash/confirmeditpayment' method='post'>
					...
					<div class="spacer">
						...
						<div class="placeholdertb">
							<input name='amount' type='text' value='<?php echo $record["amount"] ?>' style="width:300px;" />
