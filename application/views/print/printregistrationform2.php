            ...
            <div style="text-align:left; width:8.5in; margin:0 auto; margin-top:2px;">
                <table id="tblStyle" style="width:100%; font-size:12px;">
							...
							<table style="width:1in;height:1in; font-size:12px; border-collapse: collapse; border:1px #000000 solid;">
								...
								<?php 
									...
									<?php } else { 
										...
										<img src="<?php echo base_url()?>photos/female.jpg" style="width:1in; margin:5px auto;text-align:center; display:block;" />
									<?php } else { ?>
										<img src="<?php echo base_url()?>photos/male.png" style="width:1in; margin:5px auto;text-align:center; display:block;" />
									<?php 
									}
									} ?>
					...
					<tr>
						...
						<td colspan="3" style="border-bottom:1px #000 solid;"><?php echo $row["zip"]. ", ". $row["municipal"].", ". $row["regid"] ?></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="5">
							<table style="margin-left:30px; width:7.8in; font-size:12px; border-collapse: collapse; border:1px #000000 solid; text-align:center;">
								...
								<tr>
									<td style="border:1px #000 solid;"><?php echo $row["module"] ?></td>
									<td style="border:1px #000 solid;"><?php echo $row["start"] ?></td>
									<td style="border:1px #000 solid;"><?php echo $row["end"] ?></td>
									<td style="border:1px #000 solid;"><?php echo $row["venue"] ?></td>
									<td style="border:1px #000 solid;"><?php echo $row["sptypename"] ?></td>
								</tr>
